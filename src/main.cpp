...
void desenharInformacoes(double X, double Y)
{
    ...
    switch(tipoSelecionado)
    {
        ...
        case INICIO:
        {
            sprintf(modo, "Inserir área inicial");
        }   break;
        case FINAL:
        {
            sprintf(modo, "Inserir área final");
        }   break;
        case ANDAVEL:
        {
            sprintf(modo, "Inserir área andável");
        }   break;
        case OBSTACULO:
        {
            sprintf(modo, "Inserir/Remover obstáculos");
        }   break;
        case MOEDA:
        {
    ...
    sprintf(String, "Alinhamento do mouse: (espaço)");
    ...
    sprintf(String, "Estado do cenário: (enter)");
    ...
    sprintf(String, "Salvar posição mouse (i)");
    EscreverEsquerda(String, 1075, 300, FontePreta);

    sprintf(String, "Carregar posição salva (u)");
